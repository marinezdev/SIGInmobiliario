...
namespace SIG_WebApplication.Controllers
{
    ...
    {
        public ActionResult Index(Application.TipoSubCategoria tipoSubCategoria, Application.Inmueble inmueble, Application.cat_estados cat_Estados)
        {
        ...
        public JsonResult BusquedaIndex(Models.BusquedaConsultar busquedaConsultar, Application.Busquedas busquedas)
        {
            string RutaBusqueda = busquedas.BusquedaIndeX(busquedaConsultar.Busquedas);
            return Json(RutaBusqueda);
        }
        ...
        public ActionResult InmuebleDetalle(Application.Menu menu, Application.Inmueble inmueble, Application.InmueblesImg inmueblesImg, Application.Comentarios comentarios)
        {
            ...
            if (!String.IsNullOrEmpty(Request.QueryString["Inm"]))
            {
                ...
                ViewBag.TipoCategoria = inmueble1.TipoCategoria.ToUpper();
        ...
        {
            Models.Mensaje mensaje = inmueble.Llamada(consultaCorreo.correo, 0);

            return Json(mensaje);
        }
        public JsonResult Consulta(Models.ConsultaCorreo consultaCorreo, Application.Inmueble inmueble)
        {
            Models.Mensaje mensaje = inmueble.Consulta(consultaCorreo.correo, 0);

            return Json(mensaje);
        }
        public JsonResult Agenda(Models.ConsultaCorreo consultaCorreo, Application.Inmueble inmueble)
        {
            Models.Mensaje mensaje = inmueble.Agenda(consultaCorreo.correo, 0);
        ...
        /*********************************************************************************************************************************/
        public ActionResult Categorias(Application.SubCategoria subCategoria)
        {
        ...
        /*********************************************************************************************************************************/
        //[Route("~/cantacta-servicios-inmovilidarios-g")]
        ...
        public ActionResult Casas(Application.SubCategoria _subCategoria, Application.Inmueble inmueble)
        {
            List<Models.SubCategoria> subCategorias = _subCategoria.SubCategoria_Busqueda();
            Models.Busquedas busquedas = new Models.Busquedas();
        ...
        public ActionResult Departamentos(Application.SubCategoria _subCategoria, Application.Inmueble inmueble)
        {
            List<Models.SubCategoria> subCategorias = _subCategoria.SubCategoria_Busqueda();
            Models.Busquedas busquedas = new Models.Busquedas();
        ...
        public ActionResult Oficinas(Application.SubCategoria _subCategoria, Application.Inmueble inmueble)
        {
            List<Models.SubCategoria> subCategorias = _subCategoria.SubCategoria_Busqueda();
            Models.Busquedas busquedas = new Models.Busquedas();
        ...
        public ActionResult Ranchos(Application.SubCategoria _subCategoria, Application.Inmueble inmueble)
        {
            List<Models.SubCategoria> subCategorias = _subCategoria.SubCategoria_Busqueda();
            Models.Busquedas busquedas = new Models.Busquedas();
