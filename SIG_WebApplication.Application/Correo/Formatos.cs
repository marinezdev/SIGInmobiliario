...
namespace SIG_WebApplication.Application.Correo
{
    ...
    {
        public string NuevoUsuario(Models.Mensaje mensaje, Models.Usuarios usuario)
        {
            string host = HttpContext.Current.Request.Url.Authority;
            string Token = UrlCifrardo.Encrypt(mensaje.Token);
            ...
            html =  "<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Transitional//EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'>"+
                    ...
                    "<body class='respond' leftmargin='0' topmargin='0' marginwidth='0' marginheight='0'>" +
                                        ...
                                        "<tr>" +
                                            "<td align='center'>" +
                                                "<table border='0' align='center' width='590' cellpadding='0' cellspacing='0' class='container590'>" +
                                                    ...
                                                    "<tr style='background-color: #15436d;color:#ffffff'>" +
                                                        "<td align='center'>" +
                                                            "<table width='360 ' border='0' cellpadding='0' cellspacing='0' style='border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;' class='container590 hide'>" +
                                                                "<tr>" +
                                                                    "<td width='120' align='center' style='font-size: 14px; font-family: 'Proxima Nova',-apple-system,'Helvetica Neue',Helvetica,Roboto,Arial,sans-serif; line-height: 24px;'>" +
                        ...
                        "<table border='0' width='100%' cellpadding='0' cellspacing='0' bgcolor='ffffff' class='bg_color'>" +
                            "<tr>" +
                                "<td align='center'>" +
                                    "<table border='0' align='center' width='590' cellpadding='0' cellspacing='0' class='container590'>" +
                                        "<tr>" +
                                            "<td align='center' style='color: #343434; font-size: 24px; font-family: 'Proxima Nova',-apple-system,'Helvetica Neue',Helvetica,Roboto,Arial,sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;' class='main-header'>" +
                                                "<!-- section text ======-->" +
                                                "<div style='line-height: 35px'>" +
                                                    "<span style='color: #15436d;'>Servicios</span> <span style='color: #717171;'> Inmobiliarios G</span>" +
                                                "</div>" +
                                            "</td>" +
                                        "</tr>" +
                                        "<tr>" +
                                                    ...
                                                    "<tr>" +
                                                        "<td align='left' style='color: #888888; font-size: 14px; font-family: 'Proxima Nova',-apple-system,'Helvetica Neue',Helvetica,Roboto,Arial,sans-serif; line-height: 24px;'>" +
                                                            ...
                                                            "<p style='line-height: 24px; margin-bottom:15px;'>" +
                                                                "Buen día: <strong> " + usuario.Nombre + " " + usuario.Apellidos + "</strong>," +
                                                            "</p>" +
                                                            "<p style='line-height: 24px;margin-bottom:15px;'>" +
                                                                "Registro <strong>" + usuario.Email + "</strong> como su ID de cuenta SIG." +
                                                                "<br>" +
                                                                "Si hace clic en el botón, la autentificación de su cuenta será completada." +
                                                            "</p>" +
                                                                ...
                                                                "<tr>" +
                                                                    "<td align='center' style='color: #ffffff; font-size: 14px; font-family: 'Proxima Nova',-apple-system,'Helvetica Neue',Helvetica,Roboto,Arial,sans-serif; line-height: 22px;'>" +
                                                                        ...
                                                                        "<div style='line-height: 22px;'>" +
                                                                            "<a href='http://" + host + "/Adm/Autentificar?com=" + Token + "' style='padding: 15px 40px; border-radius: 3px; border-image: none; color: rgb(255, 255, 255); font-family: 'Helvetica neue', Helvetica, Arial, Verdana, sans-serif; font-size: 16px; text-decoration: none; display: inline-block;'><STRONG>ACTIVAR CUENTA</STRONG> </a>" +
                                                                        "</div>" +
                                                                    "</td>" +
                                                                "</tr>" +
                                                                "<tr>" +
                                                            ...
                                                            "<p style='line-height: 24px; margin-bottom:20px;'>" +
                                                                "Si el botón de arriba no funciona, ingrese en su navegador la siguiente dirección." +
                                                            "</p>" +
                                                            "<p style='line-height: 24px; margin-bottom:20px;padding: 10px; background-color: #C2C2C2; color: #ffffff;'>" +
                                                                "<a href=''>http://" + host + "/Adm/Autentificar?com=" + Token + "</a>" +
                                                            "</p>" +
                                                            "<p style='line-height: 24px; margin-bottom:20px;'>" +
                                                                "<strong>¿Usted no solicito una cuenta con nosotros?</strong>   <br>" +
                                                                "Es posible que otro usuario haya registrado la dirección la dirección de correo electrónico incorrecta por error. Haga clic en el siguiente botón si usted no creo una cuenta en SIG." +
                                                            "</p>" +
                                                            "<table border='0' align='center' width='180' cellpadding='0' cellspacing='0' bgcolor='15436d' style='margin-bottom:20px;border-radius: 10px 10px 10px 10px;-moz-border-radius: 10px 10px 10px 10px;-webkit-border-radius: 10px 10px 10px 10px;border: 0px solid #000000;'>" +
                                                                "<tr>" +
                                                                    "<td height='10' style='font-size: 10px; line-height: 10px;'>&nbsp;</td>" +
                                                                ...
                                                                "<tr>" +
                                                                    "<td align='center' style='color: #ffffff; font-size: 14px; font-family: 'Proxima Nova',-apple-system,'Helvetica Neue',Helvetica,Roboto,Arial,sans-serif; line-height: 22px;'>" +
                                                                        "<!-- main section button -->" +
                                                                        "<div style='line-height: 22px;'>" +
                                                                            "<a href='http://" + host + "/Adm/Decline?com=" + Token + "' style='color: #ffffff; text-decoration: none; font-family: 'Proxima Nova',-apple-system,'Helvetica Neue',Helvetica,Roboto,Arial,sans-serif;'><STRONG>PROTEGER CUENTA </STRONG> </a>" +
                                                                        "</div>" +
                                                                    "</td>" +
                                                                "</tr>" +
                                                                "<tr>" +
                        ...
                        "<table border='0' width='100%' cellpadding='0' cellspacing='0' bgcolor='2a2e36'>" +
                            "<tr>" +
                                "<td align='center' style='background-image: url(http://www.serviciosinmobiliariosg.com.mx/01/offica-home.jpg); background-size: cover; background-position: top center; background-repeat: no-repeat;' background='http://www.serviciosinmobiliariosg.com.mx/01/Header1.jpg'>" +
                                    "<table border='0' align='center' width='590' cellpadding='0' cellspacing='0' class='container590'>" +
                                        "<tr>" +
                                                    ...
                                                    "<tr>" +
                                                        "<td align='center'>" +
                                                            "<table border='0' align='center' cellpadding='0' cellspacing='0' class='container580'>" +
                                                                "<tr>" +
                                                                    "<td align='center' style='color: #ffffff; background-color: #15436d; font-size: 16px; font-family: 'Proxima Nova',-apple-system,'Helvetica Neue',Helvetica,Roboto,Arial,sans-serif; line-height: 26px;'>" +
                                                                        "<!-- section text ======-->" +
                                                ...
                                                "<table border='0' align='center' width='250' cellpadding='0' cellspacing='0' style='border:2px solid #ffffff;'>" +
                                                    ...
                                                    "<tr>" +
                                                        "<td align='center' style='color: #ffffff; font-size: 14px; font-family: 'Proxima Nova',-apple-system,'Helvetica Neue',Helvetica,Roboto,Arial,sans-serif; line-height: 22px; letter-spacing: 2px;'>" +
                                                            "<!-- main section button -->" +
                                                            "<div style='line-height: 22px;'>" +
                                                                "<a href='' style='color: #fff; background-color: #15436d; text-decoration: none;'>SUSCRIBIRME </a>" +
                                                            "</div>" +
                                                        "</td>" +
                                                    "</tr>" +
                                                    "<tr>" +
                                                    ...
                                                    "<tr>" +
                                                        "<td>" +
                                                            "<table border='0' width='300' align='left' cellpadding='0' cellspacing='0' style='border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;' class='container590'>" +
                                                                ...
                                                                "</tr>" +
                                                                "<tr>" +
                                                                    "<td align='left' style='color: #888888; font-size: 14px; font-family: 'Proxima Nova',-apple-system,'Helvetica Neue',Helvetica,Roboto,Arial,sans-serif; line-height: 23px;' class='text_color'>" +
                                                    ...
                                                    "<tr>" +
                                                        "<td align='left' style='color: #aaaaaa; font-size: 14px; font-family: 'Proxima Nova',-apple-system,'Helvetica Neue',Helvetica,Roboto,Arial,sans-serif; line-height: 24px;'>" +
                                                            "<div style='line-height: 24px;'>" +
                                                                "<span style='color: #333333;'>Copyright &copy; Todos los derechos reservados |<a href='#' style='color: #d8a75f' target='_blank'> Servicios inmobiliarios G </a></span>" +
                                                            "</div>" +
                                                        "</td>" +
                                                    "</tr>" +
                                                "</table>" +
                                                    ...
                                                    "<tr>" +
                                                        "<td align='center'>" +
                                                            "<table align='center' border='0' cellpadding='0' cellspacing='0'>" +
                                                                "<tr>" +
                                                                    "<td align='center'>" +
                                                                        "<a style='font-size: 14px; font-family: 'Proxima Nova',-apple-system,'Helvetica Neue',Helvetica,Roboto,Arial,sans-serif; line-height: 24px;color: #15436d; text-decoration: none;font-weight:bold;' href='{{UnsubscribeURL}}'>SUSCRIBIRME</a>" +
                                                                    "</td>" +
                                                                "</tr>" +
                                                            "</table>" +
                                                        "</td>" +
        ...
        public string NuevoInmueble(Models.Usuarios usuario, string direccion)
        {
            string host = HttpContext.Current.Request.Url.Authority;
            //string Token = UrlCifrardo.Encrypt(mensaje.Token);
                                                ...
                                                "<table border='0' width='590' align='center' cellpadding='0' cellspacing='0' class='container590'>" +
                                                    "<tr>" +
                                                        "<td align='left' style='color: #888888; font-size: 14px; font-family: 'Proxima Nova',-apple-system,'Helvetica Neue',Helvetica,Roboto,Arial,sans-serif; line-height: 24px;'>" +
                                                            ...
                                                            "</p>" +
                                                            "<p style='line-height: 24px;margin-bottom:15px;'>" +
                                                                "Se a registrado un nuevo inmueble, se requiere revisar la información, antes de que este sea publicado." +
                                                                "<br>" +
                                                                "Si hace clic en el botón, ingresara directamente al inmueble." +
                                                            "</p>" +
                                                            "<table border='0' align='center' width='180' cellpadding='0' cellspacing='0' bgcolor='15436d' style='margin-bottom:20px;border-radius: 10px 10px 10px 10px;-moz-border-radius: 10px 10px 10px 10px;-webkit-border-radius: 10px 10px 10px 10px;border: 0px solid #000000;'>" +
                                                                "<tr>" +
                                                                    "<td height='10' style='font-size: 10px; line-height: 10px;'>&nbsp;</td>" +
                                                                ...
                                                                "<tr>" +
                                                                    "<td align='center' style='color: #ffffff; font-size: 14px; font-family: 'Proxima Nova',-apple-system,'Helvetica Neue',Helvetica,Roboto,Arial,sans-serif; line-height: 22px;'>" +
                                                                        "<!-- main section button -->" +
                                                                        "<div style='line-height: 22px;'>" +
                                                                            "<a href='" + direccion + "' style='padding: 15px 40px; border-radius: 3px; border-image: none; color: rgb(255, 255, 255); font-family: 'Helvetica neue', Helvetica, Arial, Verdana, sans-serif; font-size: 16px; text-decoration: none; display: inline-block;'><STRONG>EVALUAR INMUEBLE</STRONG> </a>" +
                                                                        "</div>" +
                                                                    "</td>" +
                                                                "</tr>" +
                                                                "<tr>" +
        ...
        public string RecuperarPassword(Models.Usuarios usuario)
        {
            string host = HttpContext.Current.Request.Url.Authority;
                                                ...
                                                "<table border='0' width='590' align='center' cellpadding='0' cellspacing='0' class='container590'>" +
                                                    "<tr>" +
                                                        "<td align='left' style='color: #888888; font-size: 14px; font-family: 'Proxima Nova',-apple-system,'Helvetica Neue',Helvetica,Roboto,Arial,sans-serif; line-height: 24px;'>" +
                                                            ...
                                                            "</p>" +
                                                            "<p style='line-height: 24px;margin-bottom:15px;'>" +
                                                                "Usted a solicitado recuperar su contraseña." +
                                                            "</p>" +
                                                            "<p style='line-height: 24px;margin-bottom:15px;'>" +
