...
{
    public class FormatoAgenda
    {
        public string AgendaAnunciante(Models.Correo correo, string direccion)
        {
                    ...
                    "<tr style='background-color: #15436d ;'>" +
                        "<td align='center'>" +
                            "<table width='360 ' border='0' cellpadding='0' cellspacing='0' style='border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;'" +
                                ...
                                "<tr>" +
                                    "<td width='120' align='center' style='font-size: 14px; font-family: 'Proxima Nova',-apple-system,'Helvetica Neue',Helvetica,Roboto,Arial,sans-serif; line-height: 24px;'>" +
                                        "<a href='' style='color: #ffffff; text-decoration: none;'>Pagina Web </a>" +
                                    "</td>" +
                                    "<td width='120' align='center' style='font-size: 14px; font-family: 'Proxima Nova',-apple-system,'Helvetica Neue',Helvetica,Roboto,Arial,sans-serif;line-height: 24px;'>" +
                                        "<a href='' style='color: #ffffff; text-decoration: none;'>Ayuda </a>" +
                                    "</td>" +
                                    "<td width='120' align='center' style='font-size: 14px; font-family: 'Proxima Nova',-apple-system,'Helvetica Neue',Helvetica,Roboto,Arial,sans-serif;line-height: 24px;'>" +
                ...
                "<table border='0' width='590' align='center' cellpadding='0' cellspacing='0' class='container590'>" +
                    "<tr>" +
                        "<td align='left' style='color: #888888; font-size: 14px; font-family: 'Proxima Nova',-apple-system,'Helvetica Neue',Helvetica,Roboto,Arial,sans-serif; line-height: 24px;'>" +
                            ...
                            "</p>" +
                            "<p style='line-height: 24px;margin-bottom:15px;'>" +
                                "Han visualizado un inmueble publicado por parte tuya, el interesado desea que te comuniques con el para agendar una visita al inmueble " +
                                "<br>" +
...
"<tr>" +
"<td align='center' style='background-image: url(http://www.serviciosinmobiliariosg.com.mx/01/Header1.jpg); background-size: cover; background-position: top center; background-repeat: no-repeat;'" +
    "background='http://www.serviciosinmobiliariosg.com.mx/01/Header1.jpg'>" +
                ...
                "<table border='0' align='center' width='250' cellpadding='0' cellspacing='0' style='border:2px solid #ffffff;'>" +
                    ...
                    "<tr>" +
                        "<td align='center' style='color: #ffffff; font-size: 14px; font-family: 'Proxima Nova',-apple-system,'Helvetica Neue',Helvetica,Roboto,Arial,sans-serif; line-height: 22px; letter-spacing: 2px;'>" +
                            ...
                            "<div style='line-height: 22px;'>" +
                                "<a href='' style='color: #fff; background-color: #bfbfbfc9; text-decoration: none;'>SUSCRIBIRME </a>" +
                            "</div>" +
                        "</td>" +
                    "</tr>" +
                                ...
                                "<tr>" +
                                    "<td align='center'>" +
                                        "<a style='font-size: 14px; font-family: 'Proxima Nova',-apple-system,'Helvetica Neue',Helvetica,Roboto,Arial,sans-serif; line-height: 24px;color: #17a2b8; text-decoration: none;font-weight:bold;'" +
                                            "href='{{UnsubscribeURL}}'>SUSCRIBIRME</a>" +
                                    "</td>" +
                                "</tr>" +
                            "</table>" +
                        "</td>" +
...
"</html>";
        ...
        public string AgendaCliente(Models.Correo correo, string direccion)
        {
            string host = HttpContext.Current.Request.Url.Authority;
                            ...
                            "<table border='0' width='590' align='center' cellpadding='0' cellspacing='0' class='container590'>" +
                                "<tr>" +
                                    "<td align='left' style='color: #888888; font-size: 14px; font-family: 'Proxima Nova',-apple-system,'Helvetica Neue',Helvetica,Roboto,Arial,sans-serif; line-height: 24px;'>" +
                                        ...
                                        "</p>" +
                                        "<p style='line-height: 24px;margin-bottom:15px;'>" +
                                            "Usted ha enviado un email con su numero telefónico <strong>" + correo.Telefono + "</strong>  al anunciante. Solicitando agendar una visita al inmueble " +
                                            "<br>" +
